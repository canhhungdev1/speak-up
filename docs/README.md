...
Chào mừng bạn đến với trung tâm tài liệu chính thức của dự án **SpeakUp**.
...
- [`environment-setup.md`](./04-development/environment-setup.md): Hướng dẫn cài đặt môi trường dev (Nx, NestJS, Angular, Flutter).

### [05-deployment/](./05-deployment/) — Triển khai & Hạ tầng
- [`docker-guide.md`](./05-deployment/docker-guide.md): Hướng dẫn triển khai ứng dụng bằng Docker Compose.

---

> ⚠️ **Lưu ý:** Vui lòng tuân thủ quy tắc [Docs-as-Code](../.agent/rules/documentation-rules.md). Mọi cập nhật tính năng mới đều phải đi kèm việc cập nhật tài liệu tương ứng tại đây.
