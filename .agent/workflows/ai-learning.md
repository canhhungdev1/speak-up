---
description: Lưu learnings từ conversation hiện tại vào .agent/learnings/ theo chủ đề
---
...
AI **PHẢI** đọc danh sách file trong `.agent/learnings/` trước tiên để biết những feature nào đã có file.
...
### File path: `.agent/learnings/[feature-name].md`
